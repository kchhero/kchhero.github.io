(function($) {
 ...
 function init() {
    ...
    /**
     * Tags & category tab activation based on hash value. If hash is undefined then first tab is activated.
     */
    function activateTab() {
      if(['/tags.html', '/about.html'].indexOf(window.location.pathname) > -1) {
